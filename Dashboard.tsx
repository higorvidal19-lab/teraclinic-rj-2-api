  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="flex flex-col w-64 bg-white border-r">
        <div className="flex items-center justify-start h-20 px-4 border-b gap-3">
          {settings.logoUrl && (
            <img src={settings.logoUrl} alt="Clinic Logo" className="h-12 max-w-[48px] object-contain"/>
          )}
